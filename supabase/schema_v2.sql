-- ============================================================
-- EMS PROFESSIONAL SCHEMA v2 — Run in Supabase SQL Editor
-- ============================================================

-- Drop existing enums if recreating (be careful in production)
...
-- ─── TASKS (Enhanced) ───────────────────────────────────────
-- tasks table already exists; add columns via ALTER if needed
